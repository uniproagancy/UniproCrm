<div class="modal modal-slide-in fade" wire:ignore.self id="filterOrderModal" tabindex="-1">
        ...
        <form class="modal-content pt-0" wire:submit.prevent="applyFilters" wire:keydown.enter="applyFilters">
            ...
            <div class="modal-body flex-grow-1">
                <div class="mb-1">
                    ...
                    <input type="text" class="form-control" placeholder="შიდა ID, მომხმარებლის ტელეფონის ნომერი, SS ID, MyHome ID"
                           wire:model.debounce.500ms="search_query" />
                </div>
                <div class="mb-1">
                    <label class="form-label">აგენტი</label>
                    <select class="form-select" wire:model="filter_agent_id">
                        <option value=""></option>
