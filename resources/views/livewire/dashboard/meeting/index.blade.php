@section('page_css')
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard-assets/vendors/css/calendars/fullcalendar.min.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard-assets/css/pages/app-calendar.css') }}">
<link rel="stylesheet" type="text/css" href="{{ asset('dashboard-assets/vendors/css/pickers/flatpickr/flatpickr.min.css') }}">
@endsection
                ...
                <div class="app-calendar overflow-hidden border">
                    <div class="row g-0">
                        ...
                        <div class="col app-calendar-sidebar flex-grow-0 overflow-hidden d-flex flex-column" id="app-calendar-sidebar">
                            <div class="sidebar-wrapper">
                                <div class="card-body d-flex justify-content-center">
                                    <button class="btn btn-primary btn-toggle-sidebar w-100" data-bs-toggle="modal" data-bs-target="#add-new-sidebar">
                                        <span class="align-middle">შეხვედრის დამატება</span>
                                    </button>
                                </div>
                                <div class="card-body pb-0">
                                    <h5 class="section-label mb-1">
                                        <span class="align-middle">ფილტრი</span>
                                    </h5>
                            ...
                            <div class="mt-auto">
                                <img src="{{ asset('dashboard-assets/images/pages/calendar-illustration.png') }}" alt="Calendar illustration" class="img-fluid" />
                            </div>
                        </div>
                        <!-- /Sidebar -->
...
<script src="{{ asset('dashboard-assets/vendors/js/extensions/moment.min.js') }}"></script>
<script src="{{ asset('dashboard-assets/vendors/js/calendar/fullcalendar.min.js') }}"></script>
<script src="{{ asset('dashboard-assets/vendors/js/pickers/flatpickr/flatpickr.min.js') }}"></script>
<script src="{{ asset('dashboard-assets/js/scripts/pages/app-calendar-events.js') }}"></script>
<script src="{{ asset('dashboard-assets/js/scripts/pages/app-calendar.js') }}"></script>
@endsection
